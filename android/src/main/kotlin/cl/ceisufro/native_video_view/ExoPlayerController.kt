...
import java.util.*
import com.google.android.exoplayer2.upstream.DefaultDataSourceFactory as DefaultDataSourceFactory
...
class ExoPlayerController(
    ...
    private fun initVideo(dataSource: String?) {
        ...
        if (dataSource != null) {
            ...
            // ERROR:  Type mismatch: inferred type is String but DataSource.Factory was expected
            val dataSourceFactory = DefaultDataSourceFactory(context, jsonSinComillas)            
